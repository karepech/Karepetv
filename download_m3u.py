...
CONFIGURATIONS = [
    {
        "urls": ["https://bit.ly/KPL203", "liveevent.iptvbonekoe.workers.dev", "https://freeiptv2026.tsender57.workers.dev"],
...
if __name__ == "__main__":
    ...
    print("\nProses Multi-Filter selesai.")", "https://bit.ly/TVKITKAT", "https://freeiptv2026.tsender57.workers.dev"],
        "output_file": "event_combined.m3u",
        "keywords": ALL_POSITIVE_KEYWORDS["EVENT_ONLY"],
        "description": "EVENT: Gabungan dari beberapa sumber"
    },
